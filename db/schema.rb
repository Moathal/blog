...
ActiveRecord::Schema[7.0].define(version: 2022_12_16_132714) do
  ...
  add_foreign_key "comments", "bloggers", column: "author_id"
  add_foreign_key "comments", "posts"
  add_foreign_key "likes", "bloggers", column: "author_id"
  add_foreign_key "likes", "posts"
  add_foreign_key "posts", "bloggers", column: "author_id"
end
