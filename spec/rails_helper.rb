...
RSpec.configure do |config|
  ...
  # instead of true.
  config.use_transactional_fixtures = false # modified to be false for capybara
  ...
  # The code below was added for capybara testing also some above were modified or added
